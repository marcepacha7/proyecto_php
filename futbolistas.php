...
<body>
	...
	<section class="futbolistas">
		<h1>futbolistas</h1>
		<div class="personaje__botonera">
		<ul>
			<li><a href="futbolistas.php?futbolistas=db">cristiano ronaldo</a></li>
			<li><a href="futbolistas.php?futbolistas=hd">messi</a></li>
			<li><a href="futbolistas.php?futbolistas=mg">riquelme</a></li>
		</ul>
	</div>
	...
	if (isset($_GET['futbolistas'])) {
	 	switch ($_GET['futbolistas']) {
	 		...
	 		case 'mg':
	 		$futbolista = "riquelme";
	 		$descripcion = "juan romana riquelme es el mayor idolo en la histira de boca juniors, ganador de 4 copa libertadores y ganador de una copa intercontinental ganandole al real madrid,fue jugador del barcelona pero su mayor trayectoria la hizo en el virrareal llegando a una semi final de champions";
	 		$img="riquelme.jpg";
